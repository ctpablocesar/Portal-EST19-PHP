<?php
    ...
    if (in_array($imagen_tipo, $imagen_tipo_permitido)) {
        if ($imagen_tamanio < 1024000) {
            ...
            $sql = "INSERT INTO anuncios (titulo, descripcion, fecha, link, imagen, status) VALUES ('$titulo', '$descripcion', '$fecha', '$link', '$imagen_nombre', '$status')";
            if (mysqli_query($conn, $sql)) {
                echo "Anuncio agregada correctamente";
            } else {
